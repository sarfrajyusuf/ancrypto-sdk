...
exports.AncryptoSdk = void 0;
const crypto_js_1 = __importDefault(require("crypto-js"));
const ethers_1 = require("ethers");
const constant_1 = require("./constant");
const abi_json_1 = __importDefault(require("../assets/abi.json"));
class AncryptoSdk {
    constructor(rpc, x_access_key = "") {
        this.x_access_key = x_access_key;
        this.provider = new ethers_1.ethers.JsonRpcProvider(rpc);
        this.contractObj = new ethers_1.ethers.Contract(constant_1.CONTRACT_ADDRESS, abi_json_1.default, this.provider);
    ...
    recoverAddress({ username, signature }) {
        return ethers_1.ethers.verifyMessage(username, signature);
    }
    /**
    ...
    encryptMessage({ message, signature }) {
        return __awaiter(this, void 0, void 0, function* () {
            const encrypted = crypto_js_1.default.AES.encrypt(message, signature).toString();
            return encrypted;
        });
    }
    /**
    ...
    decryptMessage({ message, signature }) {
        return __awaiter(this, void 0, void 0, function* () {
            const bytes = crypto_js_1.default.AES.decrypt(message, signature);
    ...
    createIdentity(requestData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield fetch(`${constant_1.ANCRYPTO_BACKEND_URL}users/decentralized`, config);
                if (response.ok) {
                    return "response";
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data && data.ancrypto_url) {
                    ...
                    response = yield fetch(`${constant_1.ANCRYPTO_BACKEND_URL}users/signature/${username}`, config);
                    if (!response.ok) {
                        throw new Error(`Network response was not ok: ${response.status} ${response.statusText}`);
                    }
                    data = yield response.json();
    ...
    getSignature(username) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let response = yield fetch(`${constant_1.ANCRYPTO_BACKEND_URL}users/signature/${username}`, config);
                if (!response.ok) {
                    throw new Error(`Network response was not ok: ${response.status} ${response.statusText}`);
                }
                let data = yield response.json();
    ...
    verificationAddresses(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield fetch(constant_1.VERIFICATION_BACKEND_URL, config);
                if (!response.ok) {
                    throw new Error(`Network response was not ok: ${response.status} ${response.statusText}`);
                }
                return true;
...
exports.AncryptoSdk = AncryptoSdk;
