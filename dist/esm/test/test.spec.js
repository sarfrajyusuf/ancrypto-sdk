...
import { OPBNB_TESTNET_RPC } from "../src/constant";
...
describe("Using SDK for User Identity", () => {
    ...
    describe("Check Username Exist or not", () => {
        it("Should be username already exist", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield obj.isUserExist(username)).to.be.equal(true);
        }));
        it("Should be username does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield obj.isUserExist("username")).to.be.equal(false);
        }));
    });
    ...
    describe.only("post user identity request on blockchain", () => {
        ...
        it("Should throw an error if username not match with special characters", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "Invalid characters in username. Only uppercase, lowercase, @, -, and _ are allowed!");
        }));
        it("Should throw an error if username is not provided", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "Username is empty!");
        }));
        /**
        ...
        it("Should throw an error if username is longer than 20 characters", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "Username must be less than 20 characters");
        }));
        /**
        ...
        it("Should throw an error if invalid address", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "From address is not a valid address");
        }));
        /**
        ...
        it("Should throw an error if invalid signature", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "Signature is required!");
        }));
        /**
        ...
        it("Should throw an error if invalid addresses", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createJsonForEncryption(requestData)).to.be.rejectedWith(Error, "Addresses are required as per sample data!");
        }));
        it("Should be encrypted string using signature", () => __awaiter(void 0, void 0, void 0, function* () {
            // Recover the address from the signature and message
            const jsonData = yield obj.createJsonForEncryption(sampleData2);
        ...
        it("Should be post the data on blockchain", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.createIdentity(requestData)).to.be.rejectedWith(Error, "Username already exists!");
        }));
        //important
        it.only("Should be post the data on blockchain successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const res = yield obj.createIdentity(sampleData4);
    ...
    describe("Resolve Address as per network", () => {
        ...
        it("Should throw an error when the username does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.resolveAddress(requestData)).to.be.rejectedWith(Error, "Username does not exist!");
        }));
        /**
        ...
        it("Should throw an error if username is longer than 20 characters", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.resolveAddress({ username: requestData.username, network: "eth" })).to.be.rejectedWith(Error, "Username must be less than 20 characters");
        }));
        it("Should throw an error if network is not provided", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.resolveAddress({
    ...
    describe("Get Signature as per username", () => {
        it("Should throw an error if username is not provided", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(obj.getSignature("")).to.be.rejectedWith(Error, "Username is empty!");
        }));
        it("Should throw an error when the username does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            const requestData = {
                username: "sarfraj31",
            };
            yield expect(obj.getSignature(requestData.username)).to.be.rejectedWith(Error, "Username does not exist!");
        }));
        it("Should throw an error if username is longer than 20 characters", () => __awaiter(void 0, void 0, void 0, function* () {
            const requestData = {
                username: "sarfraj2sarfraj2sarfraj2", //Invalid:long characters
            };
            yield expect(obj.getSignature(requestData.username)).to.be.rejectedWith(Error, "Username must be less than 20 characters");
        }));
        it("Should be resolve address", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(address.toLowerCase()).to.be.equal("0x68673c6e0ff955731334999f63b0083689318c31");
        }));
    });
    //update addresses
    describe("update addresses on blockchain", () => {
        ...
        it("Should throw an error when the username does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.updateIdentity(requestData)).to.be.rejectedWith(Error, "Username does not exists!");
        }));
        it("Should be able to update addresses on blockchain", () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const res = yield obj.updateIdentity(sampleData3);
                expect(res).to.be.a("string");
            }
            catch (error) {
                if (error.response &&
    ...
    describe("Verification of addresses of sdk", () => {
        it("should throw an error when signature is not provided for network", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.verificationAddresses(request)).to.be.rejectedWith("Empty signature!");
        }));
        it("should throw an error when address is not provided", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.verificationAddresses(request)).to.be.rejectedWith("Empty address!");
        }));
        it("Should throw an error for invalid Ethereum address", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.verificationAddresses(request)).to.be.rejectedWith("Invalid eth address!");
        }));
        it("Should throw an error if the signature for invalid", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(obj.verificationAddresses(requestData)).to.be.rejectedWith("Invalid Signature polygon!");
        }));
        it("Should be able to verify the address", () => __awaiter(void 0, void 0, void 0, function* () {
            const a = yield obj.verificationAddresses(sampleData4);
